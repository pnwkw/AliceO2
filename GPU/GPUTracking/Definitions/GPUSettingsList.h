...
AddOption(stepSize, float, 5.0f, "", 0, "Set field line step size")
AddOption(stepCount, int, 100, "", 0, "Set field line step count")
AddOption(linesCount, int, 2000, "", 0, "Set field lines count")
